...
function [X,Y]=Convert_single_subject_data_to_matrix_parallel(subject,ROI_list) 

switch(subject)
    case 1
        dload('data-starplus-04799-v7.mat')

    case 2
        dload('data-starplus-04820-v7.mat')


    case 3
        dload('data-starplus-04847-v7.mat')

    case 4
        dload('data-starplus-05675-v7.mat')

    case 5
        dload('data-starplus-05680-v7.mat')

    case 6
        dload('data-starplus-05710-v7.mat')
end
