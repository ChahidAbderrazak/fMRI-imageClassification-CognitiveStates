...
%     figure(1);histogram(Xp);hold on;histogram(Xn)
    ...
    one_vec=ones(cnt,1);
    Output_k =[ j*one_vec, M_list', Accuracy,Sensitivity,Specificity,Precision,Gmean,F1score];
...
colnames={'Shuffle', 'M','Accuracy','Sensitivity','Specificity','Precision','Gmean','F1score'};
