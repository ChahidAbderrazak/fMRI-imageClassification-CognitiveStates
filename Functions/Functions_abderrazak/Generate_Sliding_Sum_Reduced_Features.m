function  [ SS1_PR_featuresA0,  SS1_PR_featuresC0,  SS1_PR_featuresG0,  SS1_PR_featuresT0,SS1_P_TOP100_features,SS1_P_TOP0_features, idxA0, idxC0, idxG0, idxT0]...
           =Generate_Sliding_Sum_Reduced_Features( TR, Nb ,step, pos_EIIP_Seq0, neg_EIIP_Seq0, Patern_Value,Th_Seq, Name_Seq)

close all

global idxA idxC idxG idxT
if TR==1
    Results_path='../Reduced_features/figures/SS1_TR_';
else
    Results_path='../Reduced_features/figures/SS1_TS_';
...
%     save(strcat(Results_path,Name_Seq{k},'/features_variables.mat'));
    ...
    eval([strcat('idx',Name_Seq{k},'=find(W_err_sm>=Th_Seq(1,k));')])
...
%% #################   Build the features    ########################
%% Top positions
SS1_P_TOP100_features=[SS1_P_TOP100_featuresA SS1_P_TOP100_featuresT SS1_P_TOP100_featuresC SS1_P_TOP100_featuresG  Target_bit];
SS1_P_TOP0_features=[SS1_P_TOP0_featuresA SS1_P_TOP0_featuresT SS1_P_TOP0_featuresC SS1_P_TOP0_featuresG  Target_bit];
