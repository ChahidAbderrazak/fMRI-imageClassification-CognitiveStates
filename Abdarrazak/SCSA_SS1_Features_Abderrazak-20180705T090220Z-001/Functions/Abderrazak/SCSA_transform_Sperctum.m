...
function [h, Ys,Nh,Eigen_Spectrum, ProbaDNA]= SCSA_transform_Sperctum(Nh0,Y,fs,gm)
...
for i=1:N
    ...
    h0=7;
    while stop==0 
         [h1, yscsa,Nh1,Eigen_Spectrum0 psinnor]= SCSA1D_vector(y, fs,h0,gm);
...
%     Proba=psinnor.^2'
    ...
    Eigen_Spectrum00=Eigen_Spectrum0(1:Nh1)';
    Eigen_Spectrum(i,1:Nh1)=[Eigen_Spectrum00];
