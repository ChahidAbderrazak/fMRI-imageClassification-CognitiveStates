...
function acc = Old_LeaveOut_PWM(X,Y)
        ...
        for i=41:79
            for j=1:size(X,2)
                if X_train(i,j)==1
                    ...
                    PWM_S_ex(i-1,j)= PWM_S(1,j);
                elseif X_train(i,j)==2
                    PWM_S_ex(i-(size(X,1)/2),j)= PWM_P(2,j);
                    PWM_S_ex(i-1,j)= PWM_S(2,j);
                elseif X_train(i,j)==3
                    PWM_S_ex(i-(size(X,1)/2),j)= PWM_P(3,j);
                    PWM_S_ex(i-1,j)= PWM_S(3,j);
                elseif X_train(i,j)==4
                    PWM_S_ex(i-(size(X,1)/2),j)= PWM_P(4,j);
                    PWM_S_ex(i-1,j)= PWM_S(4,j);
                elseif X_train(i,j)==5
                    PWM_S_ex(i-(size(X,1)/2),j)= PWM_P(5,j);
                    PWM_S_ex(i-1,j)= PWM_S(5,j);
                end
            end
        end
        for i=1:size(X,2)
                if X_test(1,j)==1
                    PWM_S_ex_test(1,i)= PWM_P(1,i);
                    PWM_S_ex_test(2,i)= PWM_S(1,i);
                elseif X_test(1,j)==2
                    PWM_S_ex_test(1,i)= PWM_P(2,j);
                    PWM_S_ex_test(2,i)= PWM_S(2,i);
                elseif X_test(1,j)==3
                    PWM_S_ex_test(1,i)= PWM_P(3,i);
                    PWM_S_ex_test(2,i)= PWM_S(3,i);
                elseif X_test(1,j)==4
                    PWM_S_ex_test(1,i)= PWM_P(4,i);
                    PWM_S_ex_test(2,i)= PWM_S(4,i);
                elseif X_test(1,j)==5
                    PWM_S_ex_test(1,i)= PWM_P(5,i);
                    PWM_S_ex_test(2,i)= PWM_S(5,i);
                end
        end
...
%         PWM(41:79,2)=PWM_ex(40:78,2);
        PWM(41:79,2)=PWM_ex(1:39,2);
        PWM(41:79,1)=PWM_ex(40:78,2);
...
%         PWM(40:79,2)=PWM_ex(41:80,2);
        PWM(40:79,2)=PWM_ex(1:40,2);
        PWM(40:79,1)=PWM_ex(41:80,2);
